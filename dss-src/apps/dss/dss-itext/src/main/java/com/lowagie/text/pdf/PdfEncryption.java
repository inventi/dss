...
public class PdfEncryption {
	...
	public static byte[] createDocumentId() {
        ...
        // ORIGINAL: long time = System.currentTimeMillis();
        // ORIGINAL: long mem = Runtime.getRuntime().freeMemory();
        // ORIGINAL: String s = time + "+" + mem + "+" + (seq++);
        // ORIGINAL: return md5.digest(s.getBytes());
		return md5.digest("".getBytes());
        // ARHS: change end
	}
