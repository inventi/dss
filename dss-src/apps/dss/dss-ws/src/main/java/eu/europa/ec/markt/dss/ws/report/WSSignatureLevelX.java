...
public class WSSignatureLevelX {
     ...
     */
    public void setSignatureAndRefsTimestampsVerification(
            List<WSTimestampVerificationResult> signatureAndRefsTimestampsVerification) {
     ...
     */
    public void setReferencesTimestampsVerification(
            List<WSTimestampVerificationResult> referencesTimestampsVerification) {
