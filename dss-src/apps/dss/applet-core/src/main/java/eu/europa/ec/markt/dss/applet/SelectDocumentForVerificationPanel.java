...
/**
 * Let the user choose a file to verify. 
 * 
 *
 *
...
public class SelectDocumentForVerificationPanel extends AbstractWizardPanel {

    public static final String ID = "CHOOSE_FILE_TO_VALIDATE";
    ...
    public SelectDocumentForVerificationPanel(SignatureWizardModel signatureModel) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText(bundle.getString("SIGNED_FILE_TO_VALIDATE")); // NOI18N
        ...
        jButton1.setName("signed_browse"); // NOI18N
        ...
        filename.setName("signed_path"); // NOI18N

        jLabel2.setText(bundle.getString("ONLY_WHEN_DETACHED_ORGFILEJAVA"));

        jLabel3.setText(bundle.getString("ORIGINAL_FILE")); // NOI18N

        orignalFileName.setEditable(false);
        orignalFileName.setText(bundle.getString("ONLY_IF_DETACHEDJAVA"));
        ...
        jButton2.setName("original_browse"); // NOI18N
        ...
        clearButton.setMnemonic(java.util.ResourceBundle.getBundle("eu/europa/ec/markt/dss/applet/i18n").getString("CLEAR_MNEMONIC").charAt(0));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(filename, javax.swing.GroupLayout.DEFAULT_SIZE, 293, Short.MAX_VALUE))
    ...
    public Object getNextPanelDescriptor() {
        if(model.getSignedFile() != null) {
            return SignatureValidationReportPanel.ID;
        } else {
            return null;
        }
    }
