...
public class CannotFetchDataException extends RuntimeException {
     ...
     */
    public enum MSG {
        IO_EXCEPTION, TIMOUT_EXCEPTION, SIZE_LIMIT_EXCEPTION, UNKNOWN_HOST_EXCEPTION
    }

    /**
     * 
     * The default constructor for BadPasswordException.
     * 
     * @param message
     */
    ...
    /**
     * 
     * The default constructor for CannotFetchDataException.
     * 
     * @param ex
     */
