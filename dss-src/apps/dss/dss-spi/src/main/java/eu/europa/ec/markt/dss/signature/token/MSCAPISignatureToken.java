...
public class MSCAPISignatureToken implements SignatureTokenConnection {
    ...
    public byte[] sign(InputStream stream, DigestAlgorithm digestAlgo, DSSPrivateKeyEntry keyEntry)
        ...
        try {
            Signature signature = Signature.getInstance(keyEntry.getSignatureAlgorithm().getJavaSignatureAlgorithm(digestAlgo));
    ...
    public List<DSSPrivateKeyEntry> getKeys() throws KeyStoreException {
        ...
        try {
            ProtectionParameter protectionParameter = new CallbackPasswordProtection(new PrefilledPasswordCallback(
                    "nimp".toCharArray()));
