...
public interface SignatureValidationCallback {
     ...
     * @param pk
     */
    void validate(PdfReader reader, PdfDictionary outerCatalog, X509Certificate signingCert, Date signingDate,
            Certificate[] certs, PdfDictionary signatureDictionary, PdfPKCS7 pk);
