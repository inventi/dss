...
public abstract class CAdESSignatureExtension implements SignatureExtension {
    ...
    abstract protected SignerInformation extendCMSSignature(CMSSignedData signedData, SignerInformation si,
     ...
     * @throws Exception
     */
    protected Attribute getTimeStampAttribute(ASN1ObjectIdentifier oid, TSPSource tsa,
            AlgorithmIdentifier digestAlgorithm, byte[] messageImprint) {
        ...
        try {
            ...
            Attribute signatureTimeStamp = new Attribute(oid, new DERSet(ASN1Object.fromByteArray(tstoken
                    .getEncoded())));
    ...
    public CMSSignedData extendCMSSignedData(CMSSignedData signedData, Document originalData,
