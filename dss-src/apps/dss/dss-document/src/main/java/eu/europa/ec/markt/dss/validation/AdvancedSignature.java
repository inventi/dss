...
public interface AdvancedSignature {
     ...
     * 
     * @param index
     * @param originalData For a detached signature, the original data are needed
     * @return
     */
    byte[] getArchiveTimestampData(int index, Document originalData) throws IOException;
     ...
     */
    boolean checkIntegrity(Document detachedDocument);
