...
public class CAdESProfileBES {
    ...
    private Attribute makeSigningCertificateAttribute(SignatureParameters parameters) {
        try {
            ...
            if (parameters.getDigestAlgorithm() == DigestAlgorithm.SHA1) {
                ...
                ESSCertIDv2 essCert = new ESSCertIDv2(new AlgorithmIdentifier(parameters.getDigestAlgorithm()
                        .getOid()), certHash);
    ...
    private Attribute makeSigningTimeAttribute(SignatureParameters parameters) {
        return new Attribute(PKCSObjectIdentifiers.pkcs_9_at_signingTime, new DERSet(new Time(
                parameters.getSigningDate())));
    }
    ...
    private Attribute makeSignerAttrAttribute(SignatureParameters parameters) {
        ...
        return new Attribute(PKCSObjectIdentifiers.id_aa_ets_signerAttr, new DERSet(new SignerAttribute(
