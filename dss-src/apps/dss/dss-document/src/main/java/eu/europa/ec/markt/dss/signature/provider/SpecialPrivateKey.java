...
/**
 * PrivateKey used to intercept digest value and signing operation
 * 
 * 
...
public class SpecialPrivateKey implements PrivateKey {
    ...
    byte[] getPreviouslyComputedSignature() {
     ...
     * 
     * @param previouslyComputedSignature
     */
    public void setPreviouslyComputedSignature(byte[] previouslyComputedSignature) {
    ...
    void setMessageDigest(byte[] messageDigest) {
