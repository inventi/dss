...
import eu.europa.ec.markt.tlmanager.view.binding.CertificateConverter;
...
public class ServiceCurrentStatusInformationPage extends TreeDataPublisher {
    ...
    private void initComponents() {
        ...
        schemeServiceInformation = new eu.europa.ec.markt.tlmanager.view.multivalue.MultivalueButton(
        ...
        serviceDefinitionURI = new eu.europa.ec.markt.tlmanager.view.multivalue.MultivalueButton(
                MultiMode.LING_NORMAL, Configuration.LanguageCodes.getEnglishLanguage(), null);
        serviceDefinitionURILabel = new javax.swing.JLabel();
        certificateButton = new eu.europa.ec.markt.tlmanager.view.certificate.CertificateButton(
                MainFrame.fileChooser);
        currentStatusStartingDate = new eu.europa.ec.markt.tlmanager.view.common.DateTimePicker();
        serviceName = new eu.europa.ec.markt.tlmanager.view.multivalue.MultivalueButton(MultiMode.LING_NORMAL,
                Configuration.LanguageCodes.getEnglishLanguage(), null);
        serviceSupplyPoints = new eu.europa.ec.markt.tlmanager.view.multivalue.MultivalueButton(
                MultiMode.MULTI_ANYURI, Configuration.LanguageCodes.getEnglishLanguage(), null);

        serviceTitle.setName("serviceTitle"); // NOI18N

        serviceTypeIdentifierLabel.setLabelFor(serviceTypeIdentifier);
        serviceTypeIdentifierLabel.setText(uiKeys
                .getString("ServiceCurrentStatusInformationPage.serviceTypeIdentifierLabel.text")); // NOI18N
        ...
        digitalIdLabel.setLabelFor(certificateButton);
        ...
        serviceCurrentStatusLabel.setText(uiKeys
                .getString("ServiceCurrentStatusInformationPage.serviceCurrentStatusLabel.text")); // NOI18N

        currentStatusStartingDateLabel.setLabelFor(currentStatusStartingDate);
        currentStatusStartingDateLabel.setText(uiKeys
                .getString("ServiceCurrentStatusInformationPage.currentStatusStartingDateLabel.text")); // NOI18N
        ...
        schemeServiceInformationLabel.setText(uiKeys
                .getString("ServiceCurrentStatusInformationPage.schemeServiceInformationLabel.text")); // NOI18N

        serviceSupplyPointsLabel.setLabelFor(serviceSupplyPoints);
        serviceSupplyPointsLabel.setText(uiKeys
                .getString("ServiceCurrentStatusInformationPage.serviceSupplyPointsLabel.text")); // NOI18N

        serviceDefinitionURI.setName("serviceDefinitionURI"); // NOI18N

        serviceDefinitionURILabel.setLabelFor(serviceDefinitionURI);
        serviceDefinitionURILabel.setText(uiKeys
                .getString("ServiceCurrentStatusInformationPage.serviceDefinitionURILabel.text")); // NOI18N

        certificateButton.setVerifyInputWhenFocusTarget(false);
        ...
        serviceTitleLayout.setHorizontalGroup(serviceTitleLayout.createParallelGroup(
                ...
                serviceTitleLayout
                        ...
                        .addGroup(
                                serviceTitleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(serviceTypeIdentifierLabel).addComponent(serviceNameLabel)
                                        .addComponent(digitalIdLabel).addComponent(serviceCurrentStatusLabel)
                        ...
                        .addGroup(
                                serviceTitleLayout
                                        ...
                                        .addComponent(serviceName, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(schemeServiceInformation,
                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(serviceTypeIdentifier, 0, 286, Short.MAX_VALUE)
                                        .addComponent(certificateButton, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                286, Short.MAX_VALUE)
                                        .addComponent(serviceCurrentStatus, 0, 286, Short.MAX_VALUE)
                                        .addComponent(currentStatusStartingDate,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, 286, Short.MAX_VALUE)
                                        .addComponent(serviceSupplyPoints, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(serviceDefinitionURI, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)).addContainerGap()));
        serviceTitleLayout.setVerticalGroup(serviceTitleLayout.createParallelGroup(
                javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                serviceTitleLayout
                        .createSequentialGroup()
                        .addContainerGap()
                        ...
                        .addGroup(
                                serviceTitleLayout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(serviceCurrentStatus, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(serviceTitle, javax.swing.GroupLayout.DEFAULT_SIZE,
    ...
    private eu.europa.ec.markt.tlmanager.view.certificate.CertificateButton certificateButton;
    ...
    private void initBinding() {
        ...
        serviceTypeIdentifier.addActionListener(new ActionListener() {

            @Override
            public void actionPerformed(ActionEvent arg0) {
                if (dataNode.getUserObject() != null
                        && ((TSPServiceType) dataNode.getUserObject()).getServiceInformation() != null) {
                    ((TSPServiceType) dataNode.getUserObject()).getServiceInformation().setServiceTypeIdentifier(
                            (String) serviceTypeIdentifier.getSelectedItem());
                }
            }
        });
        ...
        bindingManager.createBindingForComponent(certificateButton.getCertificatePanel(), "serviceDigitalIdentity",
                QNames._ServiceDigitalIdentity_QNAME.getLocalPart());
        bindingManager.appendConverter(new CertificateConverter(),
                QNames._ServiceDigitalIdentity_QNAME.getLocalPart());

        serviceCurrentStatus.addActionListener(new ActionListener() {

            @Override
            public void actionPerformed(ActionEvent arg0) {
                if (dataNode.getUserObject() != null
                        && ((TSPServiceType) dataNode.getUserObject()).getServiceInformation() != null) {
                    ((TSPServiceType) dataNode.getUserObject()).getServiceInformation().setServiceStatus(
                            (String) serviceCurrentStatus.getSelectedItem());
                }
            }
        });
    ...
    public void updateViewFromData(TSLDataNode dataNode) {
        ...
        this.serviceTypeIdentifier.setSelectedItem(serviceInformation.getServiceTypeIdentifier());
        ...
        this.serviceCurrentStatus.setSelectedItem(serviceInformation.getServiceStatus());
