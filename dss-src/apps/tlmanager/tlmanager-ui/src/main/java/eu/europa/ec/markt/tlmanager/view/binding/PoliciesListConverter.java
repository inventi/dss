 ...
 * // assume only one PoliciesSet for now - Reference: PolicySet-SingUse
 * 
 *
 * @version $Revision: 1867 $ - $Date: 2013-04-08 13:44:56 +0200 (Mon, 08 Apr 2013) $
 */

public class PoliciesListConverter extends Converter<PoliciesListType, PoliciesListAdapter> {

    /** {@inheritDoc} */
    @Override
    public PoliciesListAdapter convertForward(PoliciesListType source) {
        return new PoliciesListAdapter(source);
    }

    /** {@inheritDoc} */
    @Override
    public PoliciesListType convertReverse(PoliciesListAdapter target) {
