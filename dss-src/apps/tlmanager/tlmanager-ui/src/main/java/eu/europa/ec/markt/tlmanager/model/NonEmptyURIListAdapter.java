...
public class NonEmptyURIListAdapter implements MultipleModel {
    ...
    public void updateBeanValues() {
        ...
        multiUris.getURI().addAll(getMultiUris().getURI());
    }
    ...
    public NonEmptyURIListType getMultiUris() {
        NonEmptyURIListType uriList = new NonEmptyURIListType();
        for (Object value : values.values()) {
            uriList.getURI().add((String) value);
        }
        return uriList;
    }
    ...
    public List<Object> getValues() {
        ...
        for (Object value : values.values()) {
            if (value instanceof String && !Util.DEFAULT_NO_SELECTION_ENTRY.equals((String) value)) {
                list.add(value);
            }
        }
        return list;
