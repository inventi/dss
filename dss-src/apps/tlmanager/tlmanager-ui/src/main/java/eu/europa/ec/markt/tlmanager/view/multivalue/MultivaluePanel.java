...
public class MultivaluePanel extends JPanel implements ContentDialogCloser {
    ...
    private static final Logger LOG = Logger.getLogger(MultivaluePanel.class.getName());
        ...
        keyList.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting() && !isRefreshing) {
                    multiContent.updateContent((String) keyList.getSelectedValue());
                }
            }
        });
    }
    ...
    private void instantiateContent(MultiMode multiMode) {
        switch (multiMode) {
        case LING_NORMAL:
            multiContent = new TextContent();
            setupLanguageMode();
            break;
        case LING_POSTAL:
            multiContent = new PostalContent();
            setupLanguageMode();
            break;
        case MULTI_FIX:
            multiContent = new ComboBoxContent(multiConfValues);
            break;
        case MULTI_FREE:
            multiContent = new TextContent();
            break;
        case MULTI_ANYURI:
            multiContent = new AnyUriContent();
            break;
        case MULTI_ASI:
            multiContent = new AdditionalServiceInformationContent();
            break;
        case MULTI_TSPINEX:
            multiContent = new TSPInformationExtensionContent();
            break;
        case DIGITAL_ID:
            multiContent = new DigitalIDContent();
            break;
        default:
            LOG.severe("Cannot initialize MultiContent for: " + multiMode.name());
            return;
        }
        multiContentScrollPane.setViewportView(multiContent.getComponent());
    }
    ...
    private void initComponents() {
        ...
        keyListScrollPane = new javax.swing.JScrollPane();
        keyList = new javax.swing.JList();
        multiContentScrollPane = new javax.swing.JScrollPane();
        textValue = new javax.swing.JTextPane();
                ...
                layout.createSequentialGroup()
                        ...
                        .addGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(keyListScrollPane, javax.swing.GroupLayout.Alignment.LEADING,
                        ...
                        .addGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addComponent(closeButton, javax.swing.GroupLayout.DEFAULT_SIZE, 289,
                                                Short.MAX_VALUE)
                                        .addComponent(multiContentScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE,
                ...
                layout.createSequentialGroup()
                        ...
                        .addGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(
                                                javax.swing.GroupLayout.Alignment.TRAILING,
                                                layout.createSequentialGroup()
                                                        .addComponent(keyListScrollPane,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE, 241,
                                                                Short.MAX_VALUE)
                                                        .addPreferredGap(
                        ...
                        .addGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(removeButton).addComponent(closeButton)).addContainerGap()));
    ...
    private javax.swing.JScrollPane keyListScrollPane;
    private javax.swing.JScrollPane multiContentScrollPane;
    private javax.swing.JButton removeButton;
    private javax.swing.JTextPane textValue;
    ...
    public void notifyContentWatcher(String text) {
        for (ContentWatcher l : contentWatcherListener) {
            l.contentHasChanged(multiContent.getMultiValueModel().getValues().isEmpty(), text);
        }
    }
}