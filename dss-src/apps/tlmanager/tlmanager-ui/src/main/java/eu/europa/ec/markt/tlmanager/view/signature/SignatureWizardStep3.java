...
public class SignatureWizardStep3 implements ValidatingPanel<Object> {
    ...
    private static final Logger LOG = Logger.getLogger(SignatureWizardStep4.class.getName());
    ...
    public void readSettings(Object arg0) {
        ...
        } catch (SignatureException se) { // this should not happen because it's already checked in
