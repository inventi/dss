...
public class ServiceInformationExtensionPage extends TreeDataPublisher {
    ...
    private void initComponents() {
        ...
        schemeOperatorName = new eu.europa.ec.markt.tlmanager.view.multivalue.MultivalueButton(MultiMode.LING_NORMAL, Configuration.LanguageCodes.getEnglishLanguage(), null);
