...
/**
 * Component for a date and a time with the help of a <code>JXDatePicker</code> and a <code>JSpinner</code>.
 * 
 *
...
public class DateTimePicker extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        spinner.setMinimumSize(new java.awt.Dimension(90, 22));
        spinner.setName("spinner"); // NOI18N
        spinner.setPreferredSize(new java.awt.Dimension(90, 22));
