...
public class MainFrame extends JFrame implements ActionListener {
    ...
    private void initComponents() {
        ...
        saveAsTSLButton.setMnemonic(uiKeys.getString("MainFrame.menu.saveAs.mnemonic").charAt(0));
        ...
        saveAsTSLButton.setName("mainFrame_saveButton"); // NOI18N
    ...
    private void newAction() {
        ...
        if (composer.doesAnyTSLExist()) {
            int msg = JOptionPane.showConfirmDialog(this, uiKeys.getString("MainFrame.newList.message"),
                    uiKeys.getString("MainFrame.newList.title"), JOptionPane.OK_CANCEL_OPTION,
                    JOptionPane.QUESTION_MESSAGE);
