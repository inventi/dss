...
public class TSPInformationExtensionContent extends MultiContent {
    ...
    protected void updateValue() {
        ...
        if (value != null) {
            if (value instanceof TSPInformationExtensionModel)
                tspInformationExtensionPanel.updateCurrentValues((TSPInformationExtensionModel) value);
        } else {
            tspInformationExtensionPanel.clearModel();
        }
    }
