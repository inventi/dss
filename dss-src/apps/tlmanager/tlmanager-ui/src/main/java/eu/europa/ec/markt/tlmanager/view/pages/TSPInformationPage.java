...
public class TSPInformationPage extends TreeDataPublisher {
    ...
    private void initComponents() {
        ...
        tspName = new eu.europa.ec.markt.tlmanager.view.multivalue.MultivalueButton(MultiMode.LING_NORMAL, Configuration.LanguageCodes.getEnglishLanguage(), null);
        tradeName = new eu.europa.ec.markt.tlmanager.view.multivalue.MultivalueButton(MultiMode.LING_NORMAL, Configuration.LanguageCodes.getEnglishLanguage(), null);
        postalAddress = new eu.europa.ec.markt.tlmanager.view.multivalue.MultivalueButton(MultiMode.LING_POSTAL, Configuration.LanguageCodes.getEnglishLanguage(), null);
        electronicAddress = new eu.europa.ec.markt.tlmanager.view.multivalue.MultivalueButton(MultiMode.MULTI_ANYURI, null, null);
        informationURI = new eu.europa.ec.markt.tlmanager.view.multivalue.MultivalueButton(MultiMode.LING_NORMAL, Configuration.LanguageCodes.getEnglishLanguage(), null);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(tspTitle, javax.swing.GroupLayout.DEFAULT_SIZE, 359, Short.MAX_VALUE)
                .addContainerGap())
        );
